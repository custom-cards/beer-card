class BeerWishlistCard extends HTMLElement {
  constructor() {
    super();
  ...
  set hass(hass) {
    ...
    card_content += `
      <table>
      <thead><tr><th>Beer name</th><th>Brewery name</th></tr></thead>
      <tbody>
    `;
    ...
    root.getElementById('BeerList').innerHTML = card_content;
...
customElements.define('beer-wishlist-card', BeerWishlistCard);